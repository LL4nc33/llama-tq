...
- Bare-metal CCX-pinning: test-rig ist KVM Guest, host-cpuset würde nochmal 5-10% bringen aber separate ops-arbeit.
...
Deploy-Wrapper shippt Phase-4-Stack default-on (OMP_active env + adaptive layer-split). Existing live deploy auf internal-host:8791 nutzt das.
