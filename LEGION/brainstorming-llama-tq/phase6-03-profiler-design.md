...
- **Smoke**: `qwen3.5-0.8b-q8_0.gguf` is dense (no MoE) — useless. Use the smallest available MoE: Qwen3.X-A3B IQ2 on test-rig with `--chunks 4 -c 512 --router-stats-max-tokens 512`. Expected runtime <30 s.
