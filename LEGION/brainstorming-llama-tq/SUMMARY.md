...
- Validation auf Qwen3.X-A3B (smoke), dann 80B-IQ2_XXS auf test-rig mit CPU offload.
...
| 🟠3 | Multi-GPU split disagreement (test-rig = 2× RTX 2060) | MEDIUM | HIGH | Mask-op per-token deterministic, broadcast via existing tensor split |
