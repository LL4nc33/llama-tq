...
Same model (Qwen3.6-35B-A3B-UD-IQ2_XXS), same hardware (test-rig, 2× RTX 2060), same FA-on, ts 12,12, ctx=2048. Upstream binary: `7f5ee5496` (master). llama-tq: `1a1d49ef5` (turboquant).
