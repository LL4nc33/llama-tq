...
# Model paths
declare -A MODELS=(
  [35B-A3B]="/models/models/Qwen_Qwen3.6-35B-A3B-IQ2_XXS-bartowski.gguf"
  [4B]="/workspace/models/Qwen3.5-4B-Q4_K_M.gguf"
  [80B-A3B]="/models/models/Qwen3-Next-80B-A3B-Instruct-UD-IQ2_XXS.gguf"
  [122B]="/models/models/Qwen3.5-122B-A10B-UD-IQ2_XXS.gguf"
  [27B]="/models/models/Qwen3.6-27B-UD-IQ2_XXS.gguf"
  [Gemma4]="/models/models/gemma-4-26B-A4B-bartowski-IQ2_XXS.gguf"
  [9B]="/workspace/models/Qwen3.5-9B-Q4_K_M.gguf"
  [Ministral3B]="/models/models/Ministral-3-3B-Instruct-2512-Q4_K_M.gguf"
)
