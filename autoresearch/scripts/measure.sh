#!/usr/bin/env bash
# measure.sh — run PPL + TG for a given K/V cache config on test-rig
# Emits metrics.json with ppl, tg, score.
#
# Usage: measure.sh <K_type> <V_type> <out_dir>
# Env:   MODEL_PATH  (default: /models/models/Qwen3.6-35B-A3B-UD-IQ2_XXS.gguf)
...
MODEL_PATH="${MODEL_PATH:-/models/models/Qwen3.6-35B-A3B-UD-IQ2_XXS.gguf}"
