...
static const struct ggml_type_traits type_traits[GGML_TYPE_COUNT] = {
    ...
    [GGML_TYPE_VTQ2_3] = {
        .type_name                = "vtq2_3",
        .blck_size                = QK_VTQ_TRELLIS,
        .type_size                = sizeof(block_vtq2_3),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_vtq2_3,
        .from_float_ref           = (ggml_from_float_t) quantize_row_vtq2_3_ref,
    },
    [GGML_TYPE_VTQ3_3] = {
        .type_name                = "vtq3_3",
        .blck_size                = QK_VTQ_TRELLIS,
        .type_size                = sizeof(block_vtq3_3),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_vtq3_3,
        .from_float_ref           = (ggml_from_float_t) quantize_row_vtq3_3_ref,
    },
    [GGML_TYPE_VTQ4_3] = {
        .type_name                = "vtq4_3",
        .blck_size                = QK_VTQ_TRELLIS,
        .type_size                = sizeof(block_vtq4_3),
        .is_quantized             = true,
