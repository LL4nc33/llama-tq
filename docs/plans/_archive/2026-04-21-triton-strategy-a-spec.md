...
Standalone Triton prototype on `example.local:/workspace/llama-tq/triton-strategy-a/`. No integration into llama.cpp yet. Goal: prove the speedup algorithmically and pick a block size / layout that works.
