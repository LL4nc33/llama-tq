...
**Date:** 2026-04-23
**Target:** llama-server (localhost:8791) running Qwen3.5-35B-A3B-IQ2_XS with KTQ2_1 KV, f16 V, parallel=2
...
2. Restart current localhost:8791 service with extra flags:
   ```
