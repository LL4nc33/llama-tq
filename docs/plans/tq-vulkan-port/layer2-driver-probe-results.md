...
| Field | Value |
|---|---|
| Host | `example.local` (Ubuntu 24.04, kernel 6.8.0-111-generic) |
...
All probe sources and built binaries live on `example.local:/tmp/`:
...
No additional packages were installed on `example.local`; the LunarG SDK
