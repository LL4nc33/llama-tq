...
**Date:** 2026-05-09
**Branch:** turboquant (test build run from `/home/claude/llama-tq` @ `f477fc7a8`, dispatcher matches `1910c4180`)
**Model:** `qwen3.5-0.8b-q8_0.gguf` on gpu00, RTX 2060 dual-GPU (`-ngl 99 -mg 0 -fa 1 -c 512`)
...
## Task 2 — Empirical Tests on gpu00
