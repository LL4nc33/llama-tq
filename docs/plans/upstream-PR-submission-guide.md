...
On gpu00:
- `/home/claude/llama-cpp-upstream/` cloned fresh from ggml-org/llama.cpp master
...
cd /home/claude/llama-cpp-upstream
...
From gpu00 (or after pulling the branch to your local clone):
