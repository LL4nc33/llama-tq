...
Logs in `/workspace/sweep-phase1-20260425-0828/` auf gpu00. Zusammengefasst in `bench/plots/benchmarks.csv` (Spalten 6+7: PP/TG aktualisiert für Gemma4-bartowski-IQ2_XXS und Qwen3.6-IQ2_XXS).
