...
**Branch:** turboquant
**Build:** fbdb4a484
**Sweep:** `/workspace/sweep-gemma4-ppl-20260425-1346/` (test-rig)
...
Sweep auf test-rig, gleiche Eingabe, chunks=4:
...
- Sweep logs: `<user>@example.local:/workspace/sweep-gemma4-ppl-20260425-1346/`
