...
Stand: 2026-04-25 16:38 CEST. Live-tested auf test-rig mit aktuellem turboquant HEAD `976082f4c` (DEBUG-commits reverted, encoder OOB-fix `b771f9267` in place).

## Setup

- Model: Gemma4-26B-A4B-bartowski-IQ2_XXS (IT-finetuned, raw-wikitext gives high absolute PPL)
- Hardware: test-rig, 2× RTX 2060 (12 GB each), `-ngl 99 -ts 12,12 -fa 1`
