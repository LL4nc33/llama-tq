...
### Production Numbers (localhost:8791, Qwen3.5-35B-A3B IQ2_XS)
...
- ~~35B Production-Deploy auf `localhost:8791`~~ ✅ DONE 2026-04-20
...
### Production-Server
- `localhost:8791` — Qwen3.5-35B-A3B, VTQ_2 (ab 2026-04-20)
