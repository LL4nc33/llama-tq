...
### Production Numbers (internal-host:8791, Qwen3.5-35B-A3B IQ2_XS)
...
- ~~35B Production-Deploy auf `internal-host:8791`~~ ✅ DONE 2026-04-20
...
### Production-Server
- `internal-host:8791` — Qwen3.5-35B-A3B, VTQ_2 (ab 2026-04-20)
- `internal-host:8792` — FunctionGemma 270M (tool router)

### Testing
- Lokaler CPU-Roundtrip in `tests/trellis-phase1/`
- PPL sweep auf test-rig (wikitext-2)
