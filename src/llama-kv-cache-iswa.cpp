...
llama_kv_cache_iswa::llama_kv_cache_iswa(
    ...
    kv_base = std::make_unique<llama_kv_cache>(
            ...
            0, LLAMA_SWA_TYPE_NONE, tq_protect_layers, tq_protect_sinks, tq_deferred_k, tq_deferred_v, filter_base, reuse);
    ...
    kv_swa = std::make_unique<llama_kv_cache>(
            ...
            hparams.n_swa, hparams.swa_type, tq_protect_layers, tq_protect_sinks, tq_deferred_k, tq_deferred_v, filter_swa, reuse);
}
