...
static const std::map<llm_arch, const char *> LLM_ARCH_NAMES = {
    ...
    { LLM_ARCH_HUNYUAN_VL,       "hunyuan-vl"       },
...
static const std::map<llm_kv, const char *> LLM_KV_NAMES = {
    ...
    { LLM_KV_EAGLE3_LAYER_LOW,                  "%s.eagle3_layer_low"                  },
    { LLM_KV_EAGLE3_LAYER_MID,                  "%s.eagle3_layer_mid"                  },
    { LLM_KV_EAGLE3_LAYER_HIGH,                 "%s.eagle3_layer_high"                 },
...
static const std::map<llm_tensor, llm_tensor_info> LLM_TENSOR_INFOS = {
    ...
    {LLM_TENSOR_NEXTN_EAGLE3_FC,            {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    // Nemotron 3 Super
